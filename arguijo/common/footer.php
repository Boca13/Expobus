...
<?php if(get_theme_option('oficial')){?>
<footer role="contentinfo" id="footerexpo">
	<div id="logos"><?php if(get_theme_option('footer_imagenlogo1')):?><a href="<?php echo get_theme_option('footer_enlacelogo1');?>"><img src="<?php echo get_theme_option('footer_imagenlogo1');?>"></a><?php endif;?><?php if(get_theme_option('footer_imagenlogo2')):?><a href="<?php echo get_theme_option('footer_enlacelogo2');?>"><img src="<?php echo get_theme_option('footer_imagenlogo2');?>"></a><?php endif;?><?php if(get_theme_option('footer_imagenlogo3')):?><a href="<?php echo get_theme_option('footer_enlacelogo3');?>"><img src="<?php echo get_theme_option('footer_imagenlogo3');?>"></a><?php endif;?></div>
