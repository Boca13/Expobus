...
function preview(item) {
	$('.preview img').attr('src', $(item).find('img').attr('src'));
	$('.preview img').css('opacity','1');
}
function show(item) {
	if($('.preview img').attr('src')!=$(item).find('img').attr('src')){
...
<div class="preview" onclick="return expand();"><img/></div><div class="grid-container">
<div class="grid" id="grid">
<div class="gutter-sizer"></div>
    <?php $n=0; foreach ($attachments as $attachment): ?>
    <div class="item-sizer">
    <div class="grid-item" onclick="sel=this; n=<?php echo $n;?>; return show(this);">
